...
AutoForm.hooks({
  ...
  'nuevoGral_': {
    ...
    onSuccess: function(operation, result, template) {
      UIBlock.unblock();
      if( Session.get("dataModuloGral").callNuevo)Session.get("dataModuloGral").callNuevo();
...
UIBlock.unblock();
  ...
  'modificarGral_': {
    ...
    onSuccess: function(operation, result, template) {
      UIBlock.unblock();
      // console.log(this)
       if(callModifica) callModifica(this.currentDoc._id);
...
Template.moduloGral.rendered=function(){
 ...
 callModifica=this.data.callModifica?this.data.callModifica:null;
}
